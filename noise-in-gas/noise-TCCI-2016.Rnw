...
\author{Juan J. Merelo\inst{1} \and 
    ...
    Pablo Garc{\'i}a-S{\'a}nchez\inst{1}}
...
\ref{ss:pacman}, and automatic generation of autonomous players for
the famous RTS StarCraft, explained in subsection
\ref{ss:starcraft}. These four problems have been chosen for several
reasons, the most important of which is that we have been working on
them and thus have data %[Pedro] should the word "we" appear before
                        %"have" ? 
% Why not? - JJ
...
probabilities of different courses of action;  in Ms. Pac-Man, it is due to the nature of the game itself; and the huge amount of possibilities in StarCraft, with a big amount of units behaving independently meaning that the source of uncertainty is extremely high. Of course, it is not a complete
