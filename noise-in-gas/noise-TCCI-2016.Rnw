...
Lab. RODCP, Institut Sup\'erieur de Gestion, Tunisia \and
...
That is why, after some initial study of noise in a specific game in
\cite{merelo14:noisy}, 
...
averaging over fitness measures \cite{hansen2009method,esteban2015implicit} or using a selection threshold over which one or other
