...
libraries such as ECJ\footnote{\url{https://cs.gmu.edu/~eclab/projects/ecj/}}.
...
the Ms. Pac-Man vs Ghosts competition\footnote{\url{http://wcci12.herokuapp.com/}} \cite{Lucas2009}, where participants can submit
