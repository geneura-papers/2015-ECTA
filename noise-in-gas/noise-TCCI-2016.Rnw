...
% Antonio - The last part of the title sounds a bit strange, could not be better something like '...of the Evolutionary Optimization of Games and Neural Networks'? or '...of the Evolutionary Optimization in Uncertain Environments'
