...
Wilcoxon comparison \ref{wilcoxon:194} as a selection operator, 
...
TODO: Add summary of the description of this bot, with the appropriate references to GP for instance
