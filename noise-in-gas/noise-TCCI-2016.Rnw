...
\title{Signal in noise: a study of uncertainty in in the context of
  evolutionary optimization of games}
...
\begin{abstract}
  ...
  Noise or uncertainty appear in many optimization processes
