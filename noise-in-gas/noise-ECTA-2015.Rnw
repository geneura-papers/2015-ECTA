...
The fitness in this approach is computed as an average of the maximum score obtained by eight different Ms. Pac-Man controllers (in 30 different games each of them). Some of these controllers were the best in past editions of the international competition, so they are very tough rivals for the ghost team being evaluated.
