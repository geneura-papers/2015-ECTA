...
The fitness in this approach is computed as the maximum
score obtained by eight different Ms. Pac-Man controllers (in 30
different games each of them). Some of these controllers were the best
