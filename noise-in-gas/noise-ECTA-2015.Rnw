...
using the results obtained from the Genebot algorithm \cite{https://github.com/JJ/noisy-ga/blob/master/data/planet-wars/experiment-1.csv}. This
...
%puesta ref. - JJ
%FERGU: he corregido las refs de nuevo, son de Genebot, no de GPbot
...
%FERGU: al final no era el jerárquico, lo borro todo y lo pongo abajo corregido
