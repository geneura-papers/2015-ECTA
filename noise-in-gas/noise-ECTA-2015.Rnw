...
Recently, researchers have been paying more attention to this game due to
the Ms. Pac-Man vs Ghosts competition \cite{lucas2007ms}, where participants can submit
...
%\vfill
% Antonio - salen las referencias muy separadas del resto
