...
% Antonio - �qu� es la Escuela de Doctorado? Rub�n est� en Unit4, �no?
...
% generales - JJ
% Antonio - pues entonces no lo pongas en el t�tulo, �no? :D
...
% Antonio - 'physical' en qu� sentido? (pos esto)
...
% Antonio - seguir una distribución estadística es lo mismo que ser una variable aleatoria? (pos esto)
...
\cite{merelo14:noisy}, 
% Antonio - indicar en qué tipo de problema se estudió. Crees que aquí casaría el estudio de ruido que hicimos en Planet Wars? La referencia que he incluído en el .bib (NoisyFitness_JCST) (pos esto)
...
% Antonio - lo usar� si alguna vez tengo que ligar de nuevo. ;D
...
% y? Qué sugieres? - JJ
% Antonio - pos que lo quites aqu� o all�, que esta repetido lo mismo. ;)
...
% Antonio - Pero me refer�a a que 'in games' es muy gen�rico, mejor decir a qu� �mbito nos referimos dentro de los juegos, �no?
